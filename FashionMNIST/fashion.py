...
traindataset = datasets.FashionMNIST(root='../data', train=True, download=False, transform=transforms)
trainloader = DataLoader(traindataset, batch_size=100, shuffle=True)

testdataset = datasets.FashionMNIST(root='../data', train=False, download=False, transform=transforms)
...
for epoch in range(total_epoch):
    ...
    writer_train.add_image('fashion_images', make_grid(images, nrow=10))
    ...
    writer_test.add_image('fashion_images', make_grid(images))
