...
traindataset = datasets.CIFAR10(root='../data', train=True, download=False, transform=transforms)
trainloader = DataLoader(traindataset, batch_size=100, shuffle=True)

testdataset = datasets.CIFAR10(root='../data', train=False, download=False, transform=transforms)
...
for epoch in range(total_epoch):
    ...
    writer_train.add_image('cifar10_images', make_grid(images, nrow=10))
    ...
    writer_test.add_image('cifar10_images', make_grid(images, nrow=10))
